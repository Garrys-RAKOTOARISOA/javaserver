...
@Entity
@Table(name = "referencedureebatterie")
public class ReferenceDureeBatterie {
    @Id
    ...
    public Double getDureelimite() {
        return dureelimite;
    }

    public void setDureelimite(Double dureelimite) {
