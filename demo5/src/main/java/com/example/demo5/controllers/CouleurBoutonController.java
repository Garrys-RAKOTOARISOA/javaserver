...
public class CouleurBoutonController {
    ...
    @Autowired
    public CouleurBoutonController(CouleurBoutonPriseRepository couleurBoutonPriseRepository, CouleurBoutonBatterieRepository couleurBoutonBatterieRepository, ModuleSolarRepository moduleSolarRepository){
